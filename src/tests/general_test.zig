...
// TODO: Each loop with interpolation requires runtime iteration support
...
// TODO: Backtick template literals require JS expression evaluation
// ─────────────────────────────────────────────────────────────────────────────
...
// TODO: Unescaped attribute syntax != not yet implemented
...
test "Checkbox with checked (no value)" {
    // HTML5 terse mode: boolean attribute without value
    try expectOutput(
...
test "Checkbox with checked=true" {
    // HTML5 terse mode: checked=true renders as checked
    try expectOutput(
...
test "Checkbox with checked=false (omitted)" {
    // checked=false means no checked attribute
    try expectOutput(
...
// TODO: JS object literal parsing in attributes not yet implemented
// ─────────────────────────────────────────────────────────────────────────────
...
// TODO: JS array literal parsing in attributes not yet implemented
// ─────────────────────────────────────────────────────────────────────────────
...
// TODO: case/when requires runtime expression evaluation
// ─────────────────────────────────────────────────────────────────────────────
...
// TODO: Conditionals require runtime expression evaluation
// ─────────────────────────────────────────────────────────────────────────────
...
// TODO: Dot notation (user.description) and conditionals require runtime expression evaluation
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// Iteration Tests
// TODO: Each loop requires runtime iteration support with item context
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// Mixin Tests
// TODO: Mixins require full runtime mixin resolution and argument binding
// ─────────────────────────────────────────────────────────────────────────────
...
// TODO: Piped text whitespace handling needs lexer fix
...
// TODO: Block text whitespace preservation needs lexer fix
...
// TODO: Literal HTML passthrough needs proper whitespace handling
...
test "Self-closing void elements" {
    // HTML5 terse mode: void elements without />
    try expectOutput(
        \\img
        \\br
        \\input
...
// TODO: String concatenation requires JS expression evaluation
// ─────────────────────────────────────────────────────────────────────────────
